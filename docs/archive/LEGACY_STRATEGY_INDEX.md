# Legacy strategy index

| Historical path | Disposition | Current authority |
|-----------------|-------------|-------------------|
| `papers/STRATEGIC_RESET.md` | Legacy strategy — stub | `docs/PROJECT_CHARTER.md` |
| `papers/AZ_EXECUTION_PLAN.md` | Archived post-E1 reaction | `docs/archive/AZ_EXECUTION_PLAN_POST_E1_20260731.md` |
...
## Evidence (never archived as "superseded science")

- `papers/EMPIRICAL_FOUNDATION.md`
- `papers/EVIDENCE_LEDGER.md`
- `papers/PREREG_*`, `papers/RESULT_*`
- `trajectory/results_*.json` at tagged commits
