...
- Treating RunPod training as globally unauthorized (backend is active; costly/confirmatory runs stay experiment-scoped)
- Uploading PHI / private clinical data to RunPod
