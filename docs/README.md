...
**Typed authority** — see [PROJECT_AUTHORITY.md](PROJECT_AUTHORITY.md). No single doc stack overrides measured evidence.

```text
empirical artifacts → mission (CHARTER) → architecture → ACTIVE_NOW → EXECUTION_PLAN
```
