...
| **P2** Owner-corpus loop | Private folder eval + failure gallery | **MOSTLY DONE** |
| **P3** Corpus-agnostic extract/merge | Lift fixture-tied solvers | **NEXT** |
| **P4** Ingest SLA | OCR/PDF normalize measured recover_gap | NEXT |
