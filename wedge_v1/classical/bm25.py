"""Stdlib Okapi BM25 over paragraphs (no deps). Wedge retrieval, not a science claim."""
...
def expand_query(query: str) -> list[str]:
    """Light lexical expansion so Wedge questions match definitional prose."""
    q = tokenize(query)
    out = list(q)
    low = query.lower()
...
def top_paragraphs(
    ...
    *,
    ...
    """Wedge-facing BM25 hits as dicts for Claim evidence.
