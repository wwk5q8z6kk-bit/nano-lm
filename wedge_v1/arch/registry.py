...
LAYERS: dict[str, str] = {
    ...
    "L18": "Evaluation surfaces and reviewer-loop integration",
}
...
COMPONENTS: dict[str, dict[str, Any]] = {
    "ingest.load_corpus": {
        ...
        "invariants": [
            "doc_id=extensionless corpus-relative path",
            "identity collisions fail clearly",
            "no PHI to tracked paths",
        ],
...
def registry_snapshot() -> dict[str, Any]:
    return {
        ...
        "note": "Wedge architecture registry; not Layer-1 evidence.",
    }
