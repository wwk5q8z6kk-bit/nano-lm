"""W6 admission gate — when is marginal LM probe indicated?

Product/architecture only. Does not grant execute auth.
"""
from __future__ import annotations

from typing import Any

EXECUTE_AUTH = "AUTHORIZE_WEDGE_V1_PHASE3_LM_PROBE"
...
def evaluate_admission(
    ...
    *,
    ...
    return {
        ...
        "note": (
            "Admission ≠ execute. Synthetic clean track may be NOT_INDICATED even when "
