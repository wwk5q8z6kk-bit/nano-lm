...
- [x] Expand `.gitignore`
- [x] Owner: push freeze commits (tag still owner-gated)
- [ ] Owner: authorize tag `post-alpha-evidence-freeze-2026-07-31`

## P1 — High / this sprint (freeze-compatible)
- [x] Offline E1 U recompute pytest from committed JSON
- [x] Offline E3 normalize pytest (0/486 invariant)
- [x] Restore packaging files (`requirements.txt` / `pyproject.toml`)
- [x] Document E1 latency/cost normalization schema
