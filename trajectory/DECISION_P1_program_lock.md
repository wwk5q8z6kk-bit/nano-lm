...
| C7 | Primary science metric = **exact string match**; normalize rescues **0/486**; human pack faithful-rate **0.00** | **High (auto)** / **High-on-pack (human)** / **Medium (IAA/synonymy)** | Stage 1 EXACT_SURVIVES | Dual clinician IAA + synonym ontology still open |
